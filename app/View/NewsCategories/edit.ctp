...
<!-- Main content wrapper -->
    <div class="wrapper">
        ...
        <!-- Form -->
        <?php echo $this->Form->create('NewsCategory', array('url' => array('action' => 'edit'), 'class' => 'form'));?>
            <fieldset>
                <div class="widget">
                     <div class="title"><img src="<?php echo $this->webroot; ?>img/icons/dark/list.png" alt="" class="titleIcon" /><h6>Edit News Category</h6></div>
                     	<?php 
